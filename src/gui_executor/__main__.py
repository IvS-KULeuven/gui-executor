...
def main():
    ...
    parser.add_argument(
        ...
        "-V",
        action="store_true",
        help="print the gui-executor version number and exit",
    )
    parser.add_argument(
        "--verbose",
        "-v",
    ...
    parser.add_argument(
        "--module-path",
        action="append",
        help="module path of the Python modules and scripts",
    )
    parser.add_argument(
        "--kernel-name",
    ...
    if not single or (lock_file and lock_file.tryLock(100)):
