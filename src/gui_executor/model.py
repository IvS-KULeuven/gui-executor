...
class Model:
    ...
    def get_ui_modules(self, module_path: str = None) -> Dict[str, Any]:
    ...
    def get_ui_subpackages(self, module_path: str = None) -> Dict[str, Path]:
        return find_subpackages(module_path or self._module_path)
